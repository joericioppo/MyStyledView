...
- (void)awakeFromNib {
	...
	self.background.backgroundColor = [NSColor colorWithCalibratedHue:0.625 saturation:0.0 brightness:0.8 alpha:1.0];
	...
	self.background.innerGlow = [NSShadow shadowWithColor:[NSColor colorWithCalibratedHue:0.625 saturation:0.0 brightness:0.0 alpha:0.2]
													 offset:NSMakeSize(0.0, 0.0)
												 blurRadius:10.0];
	self.background.bottomEdgeColor = [NSColor colorWithCalibratedWhite:0.25 alpha:1.0];
